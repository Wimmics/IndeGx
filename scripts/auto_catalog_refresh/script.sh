...
lod_raw_output_file=lod_endpoints.rdf
...
java -jar $corese_jar sparql -i $tmp_lod_rdf_file -o $lod_raw_output_file -q $tmp_query_file -of rdf
java -jar $corese_jar convert -i $lod_raw_output_file -r trig -o $lod_output_file
cat $lod_output_file >> $raw_final_file
echo "Remote LOD cloud file treated, `wc -l $lod_output_file` lines"

rm $lod_output_file
rm $lod_raw_output_file
rm $tmp_query_file
...
wikidata_raw_output_file=wikidata_endpoints.rdf
wikidata_output_file=wikidata_endpoints.trig

cat $wikidata_query > $tmp_query_file
sed -i "s,SOURCE,$wikidata_endpoint,g" $tmp_query_file
java -jar $corese_jar remote-sparql -e $wikidata_endpoint -o $wikidata_raw_output_file -q $tmp_query_file -a application/rdf+xml
java -jar $corese_jar convert -i $wikidata_raw_output_file -r trig -o $wikidata_output_file
...
linkedopendata_raw_output_file=linkedopendata_endpoints.rdf
linkedopendata_output_file=linkedopendata_endpoints.trig

cat $linkedopendata_query > $tmp_query_file
sed -i "s,SOURCE,$linkedopendata_endpoint,g" $tmp_query_file
java -jar $corese_jar remote-sparql -e $linkedopendata_endpoint -o $linkedopendata_raw_output_file -q $tmp_query_file -a application/rdf+xml
java -jar $corese_jar convert -i $linkedopendata_raw_output_file -r trig -o $linkedopendata_output_file
...
rm $linkedopendata_raw_output_file
rm $tmp_query_file
...
openlink_raw_output_file=openlink_endpoints.rdf
openlink_output_file=openlink_endpoints.trig

cat $generic_endpoint_query > $tmp_query_file
sed -i "s,SOURCE,$openlink_file,g" $tmp_query_file
java -jar $corese_jar sparql -i $openlink_file -o $openlink_raw_output_file -q $tmp_query_file -of rdf
java -jar $corese_jar convert -i $openlink_raw_output_file -r trig -o $openlink_output_file
...
yummy_raw_output_file=yummy_endpoints.rdf
...
java -jar $corese_jar sparql -i $tmp_ttl_yummy_file -o $yummy_raw_output_file -q $tmp_query_file -of rdf
java -jar $corese_jar convert -i $yummy_raw_output_file -r trig -o $yummy_output_file
cat $yummy_output_file >> $raw_final_file
echo "Remote Yummy API treated, `wc -l $yummy_output_file` lines"

rm $yummy_output_file
rm $yummy_raw_output_file
rm $tmp_query_file
...
indegx_raw_output_file=indegx_endpoints.rdf
indegx_output_file=indegx_endpoints.trig

cat $generic_endpoint_query > $tmp_query_file
sed -i "s,SOURCE,$indegx_file,g" $tmp_query_file
java -jar $corese_jar sparql -i $indegx_file -o $indegx_raw_output_file -q $tmp_query_file -of rdf
java -jar $corese_jar convert -i $indegx_raw_output_file -r trig -o $indegx_output_file
cat $indegx_output_file >> $raw_final_file
echo "Remote IndeGx file treated, `wc -l $indegx_output_file` lines"

rm $indegx_output_file
rm $indegx_raw_output_file
rm $tmp_query_file
...
crawling_raw_output_file=crawling_endpoints.rdf
crawling_output_file=crawling_endpoints.trig

cat $generic_endpoint_query > $tmp_query_file
sed -i "s,SOURCE,$crawling_file,g" $tmp_query_file
java -jar $corese_jar sparql -i $crawling_file -o $crawling_raw_output_file -q $tmp_query_file -of rdf
java -jar $corese_jar convert -i $crawling_raw_output_file -r trig -o $crawling_output_file
cat $crawling_output_file >> $raw_final_file
echo "Remote IndeGx file treated, `wc -l $crawling_output_file` lines"

rm $crawling_output_file
rm $crawling_raw_output_file
rm $tmp_query_file
...
tmp_init_catalog_file=init_catalog.trig
final_raw_file=catalog.final.rdf
final_file=catalog.final.trig

echo "Init of the catalog"
echo "java -jar $corese_jar sparql -i $raw_final_file -o $tmp_raw_init_catalog_file -q $init_catalog_query -of rdf"
java -jar $corese_jar sparql -i $raw_final_file -o $tmp_raw_init_catalog_file -q $init_catalog_query -of rdf
echo "java -jar $corese_jar convert -i $tmp_raw_init_catalog_file -r trig -o $tmp_init_catalog_file"
java -jar $corese_jar convert -i $tmp_raw_init_catalog_file -r trig -o $tmp_init_catalog_file
cat $tmp_init_catalog_file >> $raw_final_file
echo "Cumulated list of endpoints contains `wc -l $raw_final_file` lines"
echo "java -jar $corese_jar sparql -i $raw_final_file -o $final_raw_file -q $final_catalog_query -of rdf"
java -jar $corese_jar sparql -i $raw_final_file -o $final_raw_file -q $final_catalog_query -of rdf
