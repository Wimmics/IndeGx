...
export function setNbFetchRetries(nb) {
...
export function setMillisecondsBetweenRetries(milliseconds) {
...
export function setMaxConccurentQueries(max) {
...
export function setDelayMillisecondsTimeForConccurentQuery(milliseconds) {
    if (milliseconds !== undefined && milliseconds !== null && milliseconds >= 0) {
 ...
 */
export function iterativePromises(args, promiseCreationFunction, delayMilliseconds = delayMillisecondsBetweenIterativePromises) {
...
export function fetchPromise(url, header = {}, method = "GET", query = "", numTry = 0) {
    let myHeaders = {};
...
export function fetchGETPromise(url, header) {
    return fetchPromise(url, header);
}
export function fetchPOSTPromise(url, query = "", header = {}) {
    return fetchPromise(url, header, "POST", query);
}
export function fetchJSONPromise(url, otherHeaders = {}) {
    let header = {};
