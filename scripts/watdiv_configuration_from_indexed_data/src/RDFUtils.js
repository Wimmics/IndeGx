...
export function sanitizeUrl(url, baseURI, filename) {
    let result = url;
...
export function fixCommonTurtleStringErrors(ttlString) {
...
function graphyQuadLoadingToStore(store, y_quad, baseURI, filename = KGI("").value) {
...
export function serializeStoreToTurtlePromise(store, baseURI) {
...
export function serializeStoreToNTriplesPromise(store, baseURI) {
    return new Promise((accept, reject) => {
        try {
...
export function serializeStoreToTriGPromise(store, baseURI) {
    return new Promise((accept, reject) => {
        try {
...
export function serializeStoreToQuadsPromise(store, baseURI) {
    return new Promise((accept, reject) => {
        try {
...
export function parseNTriplesToStore(content, store, baseURI) {
    return new Promise((accept, reject) => {
        try {
...
export function parseN3ToStore(content, store, baseURI) {
    return new Promise((accept, reject) => {
        try {
            // content = Global.unicodeToUrlendcode(content)
...
export function parseTurtleToStore(content, store, baseURI) {
    return new Promise((accept, reject) => {
        try {
...
export function parseHTMLToStore(content, store, baseURI) {
    return new Promise((accept, reject) => {
        try {
...
export function parseJSONLDToStore(content, store, baseURI) {
    return new Promise((accept, reject) => {
        try {
            // content = Global.unicodeToUrlendcode(content)
...
export function parseNQuadsToStore(content, store, baseURI) {
    return new Promise((accept, reject) => {
        try {
...
export function parseRDFXMLToStore(content, store, baseURI) {
    return new Promise((accept, reject) => {
        try {
