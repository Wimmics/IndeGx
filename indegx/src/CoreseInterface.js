...
export function sendUpdate(endpoint, queryString, timeout = defaultQueryTimeout) {
...
export function sendConstruct(endpoint, queryString, timeout) {
    let parser = new sparqljs.Parser();
...
export function sendSelect(endpoint, queryString, timeout) {
    let parser = new sparqljs.Parser();
    const parsedQuery = parser.parse(queryString);
...
export function sendAsk(endpoint, queryString, timeout) {
