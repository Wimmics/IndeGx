...
/**
    ...
    */
function readManifestEntry(uri: string, store: $rdf.Store): Promise<ManifestEntry> {
...
/**
    ...
    */
function actionFromCollection(collection: $rdf.BlankNode | $rdf.NamedNode, store: $rdf.Store): Promise<Array<ManifestEntry | Action | Manifest>> {
    let promisePool = [];
    let result: Array<ManifestEntry | Action | Manifest> = [];
    if ($rdf.isBlankNode(collection) || $rdf.isNamedNode(collection)) {
